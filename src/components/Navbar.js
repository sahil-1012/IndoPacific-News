            ...
            <>
                <nav className="navbar fixed-top navbar-expand-lg bg-primary" data-bs-theme="dark">
                    <div className="container-fluid">
                        <Link className="navbar-brand" to="/">IndoZone</Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item" style={{ position: "absolute", right: "40px" }}><Link className="nav-link " to="/about">Contact us</Link>                                </li>
                            </ul>
